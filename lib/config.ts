export const siteConfig = {
  title: 'Binface Your Place',
  subtitle: 'Joyfully ridiculous display ideas, bin-powered democracy, and intergalactic nonsense for your own little corner of Earth.',
  officialApproval: false,
  imprintText: 'A static ideas hub for private-property parody displays and harmless cardboard nonsense.',
  articleCategories: ['How To Binface Your Place','Display Ideas','Fun-Sized Rulebook','Local Silliness','The Golden Bin Awards','Party Poopers to Avoid','Inspiration','Local Legends'],
